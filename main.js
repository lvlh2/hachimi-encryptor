// CORPUS.length == 22
const CORPUS = ["哈基米", "哦那咩鲁拖", "啊西嘎", "哈呀库", "那录", "曼波", "哦马磁力", "老吴", "咪", "哈", "叮咚鸡", "大狗叫", "袋鼠鸡", "好胖好可爱", "小白手套", "AUV", "离离原上咪", "一岁一咪咪", "野火哈基咪", "春风吹又咪", "哎呦我滴妈", "胖宝宝"];
...
function encrypt(text) {
    ...
    const encryptedWords = base22List.join("").split("").map(i => reverseCorpusMap[i]);
